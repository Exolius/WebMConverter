WebMConverter
=============
WebM for mean words are bad kids. Basically, a wrapper around ffmpeg made for converting videos to WebM without having to use the command line.
...
REDACTED IMAGE BECAUSE GITHUB HATES WORDS
